...
#define list_add    azure_list_add
#define list_remove azure_list_remove

MOCKABLE_FUNCTION(, LIST_HANDLE, list_create);
MOCKABLE_FUNCTION(, void, list_destroy, LIST_HANDLE, list);
MOCKABLE_FUNCTION(, LIST_ITEM_HANDLE, azure_list_add, LIST_HANDLE, list, const void*, item);
MOCKABLE_FUNCTION(, int, azure_list_remove, LIST_HANDLE, list, LIST_ITEM_HANDLE, item_handle);
